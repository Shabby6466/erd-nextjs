...
export const citizenSchema = z.object({
  ...
  height: z
    .coerce.number({ invalid_type_error: "height must be a number conforming to the specified constraints" })
    .min(0.1, "height must be a number conforming to the specified constraints")
    .max(10, "height must be a number conforming to the specified constraints"),
  ...
  investor: z.coerce.boolean().default(false),
